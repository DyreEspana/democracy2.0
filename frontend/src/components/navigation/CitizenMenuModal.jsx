...
const CitizenMenuModal = ({isCitizenMenuOpen, setIsCitizenMenuOpen, setIsProfilePressed, setIsCitizenLoggedIn}) => {

    const handleProfile = () => {
        setIsProfilePressed(previousStatus => !previousStatus);
                ...
                <div className="mainDivCitizenMenu">
                    <ul>
                        <li className={"citizenProfile"}>
                            <Link className={"linkIcon"} to={"/citizen-profile"} onClick={handleProfile}>
                        ...
                        <li className={"signOut"}>
                            <Link className={"linkIcon"} to="/home" onClick={handleLogout}>
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                    <path
                    ...
                    <button type={"button"} onClick={closeCitizenMenu}>Close</button>
                </div>
                : ""}
        </>
    )
